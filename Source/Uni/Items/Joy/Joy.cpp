			   ...
			   1)
{
	...
	if (num_usb_joysticks >= 1) insertJoystick(0, usb_joystick0);
	if (num_usb_joysticks >= 2 && idf2) insertJoystick(1, usb_joystick1);
	if (num_usb_joysticks >= 3 && idf3) insertJoystick(2, usb_joystick2);
}
