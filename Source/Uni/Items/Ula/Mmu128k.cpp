...
/*	creator for use by derived classes:
	• MmuPlus3
*/
Mmu128k::Mmu128k(Machine* m, isa_id id, cstr o_addr, cstr i_addr) : Mmu(m, id, o_addr, i_addr)
{
	xlogIn("new Mmu128k");
}


Mmu128k::Mmu128k(Machine* m) : Mmu(m, isa_Mmu128k, o_addr_128, nullptr) { xlogIn("new Mmu128k"); }
