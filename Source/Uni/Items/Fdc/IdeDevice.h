...
public:
	...
	static const int
		...
		// misc. commands:
		CFA_REQUEST_EXTENDED_ERROR_CODE = 0x03, DEVICE_RESET = 0x08, CFA_WRITE_SECTORS_WITHOUT_ERASE = 0x38,
		READ_VERIFY_SECTORS = 0x40, EXECUTE_DEVICE_DIAGNOSTIC = 0x90, CFA_ERASE_SECTORS = 0xC0,
		CFA_WRITE_MULTIPLE_WITHOUT_ERASE = 0xCD, CFA_TRANSLATE_SECTOR = 0x87, WRITE_BUFFER = 0xE8, SET_FEATURES = 0xEF;
...
private:
	...
	void hd_wait_busy()
	{
		while (hd_mode != hd_idle) usleep(5000);
	}
