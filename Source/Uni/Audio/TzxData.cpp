...
// helper:
static	TzxBlock* read_next	(FD& fd)		noexcept(false); // DataError, FileError
...
static	TzxBlock* readFromFile(FD&, uint stopper=0)	noexcept(false); // DataError, FileError
...
/*  read block from tzx file:
	...
	returns NULL at eof
*/
TzxBlock* TzxBlock::readFromFile( FD& fd, uint stopper ) noexcept(false) // DataError, FileError
{
...
*/
//static
TzxBlock* TzxBlock::read_next(FD &fd) throws // DataError, FileError
{
...
*/
//static
void TzxData::writeFile( cstr fpath, TapeFile& tapeblocks, TzxConversionStyle style ) noexcept(false) // FileError,DataError,bad_alloc
{
...
*/
//static
void TzxData::readFile(cstr fpath, TapeFile& tapeblocks) noexcept(false) // FileError,DataError,bad_alloc
{
	...
	catch(AnyError& e)
	{
		...
		throw e;						// hiernach ist's ein AnyError ...  :-(
	}
}
