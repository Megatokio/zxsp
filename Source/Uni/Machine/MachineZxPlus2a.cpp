...
MachineZxPlus2a::MachineZxPlus2a(MachineController* m, Model model, isa_id id) : MachineZx128(m, model, id) {}

MachineZxPlus2a::MachineZxPlus2a(MachineController* m, Model model) : MachineZx128(m, model, isa_MachineZxPlus2a)
{
