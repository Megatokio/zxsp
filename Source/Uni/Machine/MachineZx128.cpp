...
MachineZx128::MachineZx128(MachineController* m, Model model, isa_id id) : MachineZxsp(m, model, id) {}

MachineZx128::MachineZx128(MachineController* m, Model model) : MachineZxsp(m, model, zx_info[model].id)
{
