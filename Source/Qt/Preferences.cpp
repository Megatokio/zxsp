...
{
public:	MyGroupLabel(cstr text) : QLabel(text)
		{
...
:	QWidget(parent)
{
	...
	QCheckBox*
		check_for_update = new QCheckBox("Check for update (daily)");
	...
	QCheckBox*
		start_open_keyboard = new QCheckBox("Open keyboard view");
	...
	QCheckBox*
		start_open_disk_drive = new QCheckBox("Open floppy disk drive");
	...
	QCheckBox*
		start_open_taperecorder = new QCheckBox("Open tape recorder");
	...
	QCheckBox*
		start_open_image = new QCheckBox("Open machine image");
	...
	QCheckBox*
		start_warn_audioin = new QCheckBox("Warn if setup of audio input fails");
	...
	QCheckBox*
		save_and_restore_sessions = new QCheckBox("Save and restore session");
	...
	QCheckBox*
		new_machine_ay = new QCheckBox("Always attach soundchip");
	...
	QCheckBox*
		new_machine_joystick = new QCheckBox("Always attach joystick");
	...
	QCheckBox*
		new_machine_rampack = new QCheckBox("Always attach Ram extension");
	...
	QCheckBox*
		new_machine_divide = new QCheckBox("Always attach DivIDE interface");
	...
	QCheckBox*
		use_individual_settings = new QCheckBox("Remember settings for each snapshot");
	...
	QCheckBox*
		auto_start_stop_tape = new QCheckBox("Auto start/stop tape");
	...
	QCheckBox*
		fast_load_tape = new QCheckBox("Instant load/save standard tape blocks");
	...
	QComboBox*
		new_machine_kbdmode = new QComboBox();
	...
	QComboBox*
		new_snapshot_kbdmode = new QComboBox();
	...
	QComboBox*
		new_machine_model = new QComboBox();
	...
	QComboBox*
		start_screen_size = new QComboBox();
		start_screen_size->addItems(QStringList()<<"Fullscreen"<<"Size x 1"<<"Size x 2"<<"Size x 3"<<"Size x 4");
	...
	gridlayout->addWidget(new MyGroupLabel("Options at startup:"),i++,0);
		...
		gridlayout->addWidget(start_screen_size,i,0); gridlayout->addWidget(new QLabel("Screen size at start"),i++,1);
	...
	gridlayout->addWidget(new MyGroupLabel("Options for new machines:"),i++,0);
		gridlayout->addWidget(new_machine_model,i,0); gridlayout->addWidget(new QLabel("Default model"),i++,1);
		gridlayout->addWidget(new_machine_kbdmode,i,0); gridlayout->addWidget(new QLabel("Default keyboard mode"),i++,1);
	...
	gridlayout->addWidget(new MyGroupLabel("Options for new snapshots:"),i++,0);
		gridlayout->addWidget(new_snapshot_kbdmode,i,0); gridlayout->addWidget(new QLabel("Default keyboard mode"),i++,1);
