...
#define key_memotech64k_dip_switches                                                                                   \
...
#define key_memoryview_datasource(N)                                                                                   \
  usingstr("gui/memoryview/%i/datasource", int(N)) /* int: 1-4; AsSeenByCpu, AllRom, RomPages, AllRam, RamPages */
